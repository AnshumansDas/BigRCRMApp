...
{
    public partial class frmCardRegistration : System.Web.UI.Page
    {
        ...
        {
            //client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            ServiceUrl = "Payment/GetCardRegistrationList";
        ...
        //{
        //    Response.Redirect("frmAddEditCardRegistration.aspx?reg_id=0");
        //}
