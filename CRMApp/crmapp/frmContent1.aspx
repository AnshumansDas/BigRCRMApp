<%@ Page Title="" Language="C#" MasterPageFile="~/crmapp/CRMBack.Master" AutoEventWireup="true" CodeBehind="frmContent1.aspx.cs" Inherits="CRMApp.crmapp.frmContent1" %>
    ...
    <%--<asp:UpdatePanel ID="upVoucheList" runat="server">
        <ContentTemplate>--%>
            <div class="col-sm-12">
                ...
                <div class="row">
                    <asp:ListView ID="lvContentList" runat="server" DataKeyNames="content_id" OnItemCommand="lvContentList_ItemCommand" OnPagePropertiesChanging="lvContentList_PagePropertiesChanging"
                        GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnItemDataBound="lvContentList_ItemDataBound">
                        <LayoutTemplate>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    <asp:DataPager ID="DataPager1" runat="server" class="btn-group btn-group-sm" PagedControlID="lvContentList" PageSize="10">
                                        <Fields>
