<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMobileReceipt.aspx.cs" Inherits="CRMApp.crmapp.frmMobileReceipt" %>
    ...
    <script type="text/javascript">
        ...
        function success() {
            ...
            if (transactionStatus.trim() == "SUCCESSFUL") {
                //CRMPayMoney.success(result, transactionId, orderNo, transactionStatus, shoppingAmount, currency, paymentDate, approvalCode, paymentChannel);
                CRMPayMoney.success(result, transactionID, orderNo, transactionStatus, shoppingAmount, currency, paymentDate, approvalCode, paymentChannel);
                //CRMPayMoney.success(result,transactionId,orderNo);
            }
                ...
                if (errorCode != null) {
                    ...
                    CRMPayMoney.cancel(result, transactionID, orderNo, transactionStatus, mentDate, approvalCode, paymentChannel, errorCode);
                }
            }
            /*
            if (token != "") {
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tr>
                    <td><asp:Label ID="lblMsg" runat="server" Text="Transaction is in Progress. Please Wait ...."></asp:Label></td>
                    <td>
