...
{
    public partial class frmNotificationAddEdit : System.Web.UI.Page
    {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                try
                {
                    ...
                    if (dtChargeType.Rows.Count > 0)
                    {
                        ...
                        //myStringUser = myStringUser.Replace("$$activationlink$$", "http://localhost:65207/crmapp/frmActivateAccount.aspx?userid=" + txtEmailId.Text.Trim());
                        // myStringUser = myStringUser.Replace("$$EmailID$$", txtEmailId.Text.Trim());
