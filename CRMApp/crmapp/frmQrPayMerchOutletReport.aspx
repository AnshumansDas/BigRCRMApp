<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmQrPayMerchOutletReport.aspx.cs" Inherits="CRMApp.crmapp.frmQrPayMerchOutletReport" MasterPageFile="~/crmapp/CRMBack.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function PrintPromotionVoucherList() {
            ...
            prntWindow.document.write('<html><head><title>QR PAY Outlet Report</title><br/>');
