<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmQrPayMerchReport.aspx.cs" Inherits="CRMApp.crmapp.frmQrPayMerchReport" MasterPageFile="~/crmapp/CRMBack.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function PrintPromotionVoucherList() {
            ...
            prntWindow.document.write('<html><head><title>QR PAY Merchant/Outlet Report</title><br/>');
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="area-title bdr mt20">
                <h2>QR Pay Merchant/Outlet Report</h2>
        ...
        <div class="col-sm-12">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                <ContentTemplate>
                    <asp:ListView ID="lvMerchOutletReport" runat="server" OnItemCommand="lvMerchOutletReport_ItemCommand"
                        GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnPagePropertiesChanging="lvMerchOutletReport_PagePropertiesChanging" OnItemDataBound="lvMerchOutletReport_ItemDataBound">
                        <LayoutTemplate>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-4 text-right">Total MDR Collection Amount : <span id="totalMDRCollectionAmt" runat="server" style="font-size: 12px;" class="label label-primary"></span></label>
                    ...
                    <asp:Panel runat="server" ID="pnlGrdPromotionVoucher" Style="display: none">
                        <asp:GridView ID="ExportGrdPromotionVoucher" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="mdr_collection_amount" HeaderText="MDR Collection Amount (RM)" />
