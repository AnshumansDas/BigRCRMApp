<%@ Page Title="" Language="C#" MasterPageFile="~/crmapp/CRMBack.Master" AutoEventWireup="true" CodeBehind="frmSetupMinimumWithdraw.aspx.cs" Inherits="CRMApp.crmapp.frmSetupMinimumWithdraw" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="col-sm-12">
                    ...
                    <div>
                        <asp:ListView ID="lvMinWithdraw" runat="server" DataKeyNames="min_withdraw_id" OnItemCommand="lvMinWithdraw_ItemCommand" OnPagePropertiesChanging="lvMinWithdraw_PagePropertiesChanging"
                            GroupPlaceholderID="groupPlaceHolder1" ItemPlaceholderID="itemPlaceHolder1" OnItemDataBound="lvMinWithdraw_ItemDataBound" OnItemEditing="lvMinWithdraw_ItemEditing">
                            <LayoutTemplate>
                                <div class="row">
                                ...
                                <table class="table table-striped" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 20%;text-align: center;">Withdraw Amount</th>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        <asp:DataPager ID="DataPager1" runat="server" class="btn-group btn-group-sm" PagedControlID="lvMinWithdraw" PageSize="10">
                                            <Fields>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add/Edit Setup Minimum Withdraw</h4>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-12">
                                        Withdraw Amount<span style="font-size: smaller; color: red;">&#42;</span>
                                        <asp:RequiredFieldValidator ID="rfvAmount" runat="server" ForeColor="Red" Font-Size="xx-small" ControlToValidate="txtAmount" ValidationGroup="submitValSetupWithdraw" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                    </label>
                                    <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-sm-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvActiveStatus" InitialValue="" runat="server" ForeColor="Red" Font-Size="xx-small" ControlToValidate="ddlActiveStatus" ValidationGroup="submitValSetupWithdraw" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                    </label>
                                    <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        <div class="form-group">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-success" OnClick="btnSave_Click" ValidationGroup="submitValSetupWithdraw" />
