<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmViewFeedback.aspx.cs" Inherits="CRMApp.crmapp.frmViewFeedback" MasterPageFile="~/crmapp/CRMBack.Master"%>
                    ...
                    <ContentTemplate>
                        <div class="row">
                          ...
                          <div>                       
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Reply By</label>
                                <div class="col-sm-8">
                                    <asp:Label ID="lblReplyby" runat="server" Text=""></asp:Label>
                                 </div>
                            </div>
                            <div class="form-group">                               
                                    <label class="col-sm-2 control-label">Reply Message</label>
                                    <div class="col-sm-8 gap-butabo">
